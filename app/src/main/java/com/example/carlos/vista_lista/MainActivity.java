package com.example.carlos.vista_lista;
...
public class MainActivity extends ListActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cursor.addRow(new Object[] {"0", R.drawable.abc_btn_check_material, "Buho", "Búho es el nombre común de aves de la familia Strigidae, del orden de las estrigiformes o aves rapaces nocturnas."});
        cursor.addRow(new Object[] {"1", R.drawable.abc_btn_check_material, "Perro", "Animal mamifero de cuatro patas, considerado como el mejor amigo del hombre."});
